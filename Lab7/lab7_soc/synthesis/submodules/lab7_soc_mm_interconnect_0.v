...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> leds_pio_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [16:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> button_s1_agent:cp_channel
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> keycode_s1_agent:cp_valid
	wire  [107:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> keycode_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // keycode_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [16:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> keycode_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> keycode_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> keycode_s1_agent:cp_endofpacket
	...
	wire  [107:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_016:sink_data
	...
	wire          keycode_s1_agent_rp_valid;                                                          // keycode_s1_agent:rp_valid -> router_017:sink_valid
	wire  [107:0] keycode_s1_agent_rp_data;                                                           // keycode_s1_agent:rp_data -> router_017:sink_data
	wire          keycode_s1_agent_rp_ready;                                                          // router_017:sink_ready -> keycode_s1_agent:rp_ready
	wire          keycode_s1_agent_rp_startofpacket;                                                  // keycode_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          keycode_s1_agent_rp_endofpacket;                                                    // keycode_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          cmd_demux_001_src7_valid;                                                           // cmd_demux_001:src7_valid -> cmd_mux_014:sink1_valid
	wire  [107:0] cmd_demux_001_src7_data;                                                            // cmd_demux_001:src7_data -> cmd_mux_014:sink1_data
	wire          cmd_demux_001_src7_ready;                                                           // cmd_mux_014:sink1_ready -> cmd_demux_001:src7_ready
	wire   [16:0] cmd_demux_001_src7_channel;                                                         // cmd_demux_001:src7_channel -> cmd_mux_014:sink1_channel
	wire          cmd_demux_001_src7_startofpacket;                                                   // cmd_demux_001:src7_startofpacket -> cmd_mux_014:sink1_startofpacket
	wire          cmd_demux_001_src7_endofpacket;                                                     // cmd_demux_001:src7_endofpacket -> cmd_mux_014:sink1_endofpacket
	wire          cmd_demux_001_src8_valid;                                                           // cmd_demux_001:src8_valid -> cmd_mux_015:sink1_valid
	wire  [107:0] cmd_demux_001_src8_data;                                                            // cmd_demux_001:src8_data -> cmd_mux_015:sink1_data
	wire          cmd_demux_001_src8_ready;                                                           // cmd_mux_015:sink1_ready -> cmd_demux_001:src8_ready
	wire   [16:0] cmd_demux_001_src8_channel;                                                         // cmd_demux_001:src8_channel -> cmd_mux_015:sink1_channel
	...
	wire          rsp_demux_014_src1_valid;                                                           // rsp_demux_014:src1_valid -> rsp_mux_001:sink7_valid
	wire  [107:0] rsp_demux_014_src1_data;                                                            // rsp_demux_014:src1_data -> rsp_mux_001:sink7_data
	wire          rsp_demux_014_src1_ready;                                                           // rsp_mux_001:sink7_ready -> rsp_demux_014:src1_ready
	wire   [16:0] rsp_demux_014_src1_channel;                                                         // rsp_demux_014:src1_channel -> rsp_mux_001:sink7_channel
	wire          rsp_demux_014_src1_startofpacket;                                                   // rsp_demux_014:src1_startofpacket -> rsp_mux_001:sink7_startofpacket
	wire          rsp_demux_014_src1_endofpacket;                                                     // rsp_demux_014:src1_endofpacket -> rsp_mux_001:sink7_endofpacket
	...
	wire  [107:0] rsp_demux_015_src1_data;                                                            // rsp_demux_015:src1_data -> rsp_mux_001:sink8_data
	wire          rsp_demux_015_src1_ready;                                                           // rsp_mux_001:sink8_ready -> rsp_demux_015:src1_ready
	wire   [16:0] rsp_demux_015_src1_channel;                                                         // rsp_demux_015:src1_channel -> rsp_mux_001:sink8_channel
	...
	wire          keycode_s1_agent_rdata_fifo_src_valid;                                              // keycode_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] keycode_s1_agent_rdata_fifo_src_data;                                               // keycode_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          keycode_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_015:in_0_ready -> keycode_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> keycode_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> keycode_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // keycode_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> keycode_s1_agent:rdata_fifo_sink_error
	...
	lab7_soc_mm_interconnect_0_router_003 router_015 (
	...
	lab7_soc_mm_interconnect_0_router_003 router_018 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_016 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_013 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_016 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink7_ready         (rsp_demux_014_src1_ready),                       //     sink7.ready
		.sink7_valid         (rsp_demux_014_src1_valid),                       //          .valid
		.sink7_channel       (rsp_demux_014_src1_channel),                     //          .channel
		.sink7_data          (rsp_demux_014_src1_data),                        //          .data
		.sink7_startofpacket (rsp_demux_014_src1_startofpacket),               //          .startofpacket
		.sink7_endofpacket   (rsp_demux_014_src1_endofpacket),                 //          .endofpacket
